...
#: none of them: a name it needs arrives through KeepupSettings.
#:
#: One more name is forbidden and is not written here -- a customer of an
#: earlier project, whose database name sat in the package until keepup-15.
#: Searching for a name means writing it down, and this package is published,
#: so a check forbidding somebody's name would be the thing disclosing it. That
#: one lives in the repository the package grew in, which is not published
#: (keepup-33).
...
PRODUCT_NAMES = ("ozon", "wildberries", "yamarket", "yookassa", "servershare",
                 "loradataset", "marketplace", "marketconnect", "russim")
